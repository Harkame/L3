...
import poo.tp1.q1.pokemon_terrestre.PokemonCasanier;

public class E2
{
	public static Pokemon create(Class<? extends Pokemon> p_class) throws InstantiationException, IllegalAccessException
	{
