package fr.harkame.l3.math.tp1;
...
public final class GrapheMatrice
{
	...
	/**
	 * Affiche le nombre de points isoles et la taille de chacune des
	 * composantes
	 */
	 ...
	 * 
	 * @param p_compteur_composantes
	 *             Tableau contenant le nombre de points d'apparition de chaque
	 *             points
	 */
